...
import static com.applitools.eyes.TestResultsStatus.Disabled;

public class SlackIntegrationOld {
    ...
    public static void main(String[] args) {
        ...
        testResults.setStatus(Disabled);
        testResults.setUrl("file:///C:/Mentoring/project/Serenity_Framework/target/site/serenity/index.html");
                //eyes.close(false);
        eyes.close(false);
        // Post to results to Slack, passing the SLACK_WEBHOOK_URL we are getting from  an environment variable
        post(testResults , SLACK_WEBHOOK_URL);
    }
